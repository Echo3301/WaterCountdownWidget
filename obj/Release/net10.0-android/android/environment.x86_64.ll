...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 10, ; uint32_t number_of_assemblies_in_apk
	i32 0, ; uint32_t bundled_assembly_name_width
	i32 28, ; uint32_t number_of_dso_cache_entries
	i32 90, ; uint32_t number_of_aot_cache_entries
	i32 17, ; uint32_t number_of_shared_libraries
	i32 u0x0200007a, ; uint32_t android_runtime_jnienv_class_token
	i32 u0x060002e6, ; uint32_t jnienv_initialize_method_token
	i32 u0x060002e5, ; uint32_t jnienv_registerjninatives_method_token
...
@aot_dso_cache = dso_local local_unnamed_addr global [90 x %struct.DSOCacheEntry] [
	%struct.DSOCacheEntry {
		i64 u0x019ef78eca126b3d, ; from name: aot-Mono.Android.so
		i64 u0x359895a3c1bd5685, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.15_name, ; name: libaot-Mono.Android.dll.so
		ptr null; void* handle
	}, ; 0
	%struct.DSOCacheEntry {
		i64 u0x01bb3f3221ee0605, ; from name: WaterCountdownWidget.so
		i64 u0x730c0f04549bccfa, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-WaterCountdownWidget.dll.so
		ptr null; void* handle
	}, ; 1
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.16_name, ; name: libaot-System.Private.CoreLib.dll.so
		ptr null; void* handle
	}, ; 2
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.14_name, ; name: libaot-Mono.Android.Runtime.dll.so
		ptr null; void* handle
	}, ; 8
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.12_name, ; name: libaot-System.Runtime.dll.so
		ptr null; void* handle
	}, ; 9
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.10_name, ; name: libaot-System.Linq.dll.so
		ptr null; void* handle
	}, ; 10
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.9_name, ; name: libaot-System.Console.dll.so
		ptr null; void* handle
	}, ; 11
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.11_name, ; name: libaot-System.Runtime.InteropServices.dll.so
		ptr null; void* handle
	}, ; 12
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x36d954c032bb688d, ; from name: WaterCountdownWidget.dll.so
		i64 u0x730c0f04549bccfa, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-WaterCountdownWidget.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0x3e7a0a36d17616e1, ; from name: WaterCountdownWidget
		i64 u0x730c0f04549bccfa, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-WaterCountdownWidget.dll.so
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.13_name, ; name: libaot-Java.Interop.dll.so
		ptr null; void* handle
	}, ; 23
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x730c0f04549bccfa, ; from name: libaot-WaterCountdownWidget.dll.so
		i64 u0x730c0f04549bccfa, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-WaterCountdownWidget.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0x9b91a5588818fad4, ; from name: aot-WaterCountdownWidget.so
		i64 u0x730c0f04549bccfa, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-WaterCountdownWidget.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0x9e1e2f8f938d02a3, ; from name: aot-WaterCountdownWidget.dll.so
		i64 u0x730c0f04549bccfa, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-WaterCountdownWidget.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0xa3956c138c0e8925, ; from name: libaot-WaterCountdownWidget
		i64 u0x730c0f04549bccfa, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-WaterCountdownWidget.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0xe4cb2ec29c1590f6, ; from name: libaot-WaterCountdownWidget.so
		i64 u0x730c0f04549bccfa, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-WaterCountdownWidget.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0xf2d89dd88c356d63, ; from name: aot-WaterCountdownWidget
		i64 u0x730c0f04549bccfa, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-WaterCountdownWidget.dll.so
...
@dso_apk_entries = dso_local local_unnamed_addr global [17 x %struct.DSOApkEntry] zeroinitializer, align 16
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [10 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 8
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [35 x i8] c"libaot-WaterCountdownWidget.dll.so\00", align 16
@.DSOCacheEntry.9_name = private unnamed_addr constant [29 x i8] c"libaot-System.Console.dll.so\00", align 16
@.DSOCacheEntry.10_name = private unnamed_addr constant [26 x i8] c"libaot-System.Linq.dll.so\00", align 16
@.DSOCacheEntry.11_name = private unnamed_addr constant [45 x i8] c"libaot-System.Runtime.InteropServices.dll.so\00", align 16
@.DSOCacheEntry.12_name = private unnamed_addr constant [29 x i8] c"libaot-System.Runtime.dll.so\00", align 16
@.DSOCacheEntry.13_name = private unnamed_addr constant [27 x i8] c"libaot-Java.Interop.dll.so\00", align 16
@.DSOCacheEntry.14_name = private unnamed_addr constant [35 x i8] c"libaot-Mono.Android.Runtime.dll.so\00", align 16
@.DSOCacheEntry.15_name = private unnamed_addr constant [27 x i8] c"libaot-Mono.Android.dll.so\00", align 16
@.DSOCacheEntry.16_name = private unnamed_addr constant [37 x i8] c"libaot-System.Private.CoreLib.dll.so\00", align 16
