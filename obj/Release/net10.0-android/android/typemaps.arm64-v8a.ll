...
; Strings
@.tmr.0 = private unnamed_addr constant [35 x i8] c"android/appwidget/AppWidgetManager\00", align 1
@.tmr.1 = private unnamed_addr constant [36 x i8] c"android/appwidget/AppWidgetProvider\00", align 1
@.tmr.2 = private unnamed_addr constant [27 x i8] c"android/widget/RemoteViews\00", align 1
@.tmr.3 = private unnamed_addr constant [19 x i8] c"android/os/Handler\00", align 1
@.tmr.4 = private unnamed_addr constant [20 x i8] c"android/os/Vibrator\00", align 1
@.tmr.5 = private unnamed_addr constant [22 x i8] c"android/os/BaseBundle\00", align 1
@.tmr.6 = private unnamed_addr constant [17 x i8] c"android/os/Build\00", align 1
@.tmr.7 = private unnamed_addr constant [25 x i8] c"android/os/Build$VERSION\00", align 1
@.tmr.8 = private unnamed_addr constant [18 x i8] c"android/os/Bundle\00", align 1
@.tmr.9 = private unnamed_addr constant [18 x i8] c"android/os/Looper\00", align 1
@.tmr.10 = private unnamed_addr constant [27 x i8] c"android/os/VibrationEffect\00", align 1
@.tmr.11 = private unnamed_addr constant [33 x i8] c"android/view/ContextThemeWrapper\00", align 1
@.tmr.12 = private unnamed_addr constant [40 x i8] c"mono/android/runtime/InputStreamAdapter\00", align 1
@.tmr.13 = private unnamed_addr constant [21 x i8] c"java/util/Collection\00", align 1
@.tmr.14 = private unnamed_addr constant [18 x i8] c"java/util/HashMap\00", align 1
@.tmr.15 = private unnamed_addr constant [20 x i8] c"java/util/ArrayList\00", align 1
@.tmr.16 = private unnamed_addr constant [32 x i8] c"mono/android/runtime/JavaObject\00", align 1
@.tmr.17 = private unnamed_addr constant [35 x i8] c"android/runtime/JavaProxyThrowable\00", align 1
@.tmr.18 = private unnamed_addr constant [18 x i8] c"java/util/HashSet\00", align 1
@.tmr.19 = private unnamed_addr constant [41 x i8] c"mono/android/runtime/OutputStreamAdapter\00", align 1
@.tmr.20 = private unnamed_addr constant [24 x i8] c"android/content/Context\00", align 1
@.tmr.21 = private unnamed_addr constant [23 x i8] c"android/content/Intent\00", align 1
@.tmr.22 = private unnamed_addr constant [34 x i8] c"android/content/BroadcastReceiver\00", align 1
@.tmr.23 = private unnamed_addr constant [30 x i8] c"android/content/ComponentName\00", align 1
@.tmr.24 = private unnamed_addr constant [31 x i8] c"android/content/ContextWrapper\00", align 1
@.tmr.25 = private unnamed_addr constant [41 x i8] c"android/content/SharedPreferences$Editor\00", align 1
@.tmr.26 = private unnamed_addr constant [67 x i8] c"android/content/SharedPreferences$OnSharedPreferenceChangeListener\00", align 1
@.tmr.27 = private unnamed_addr constant [34 x i8] c"android/content/SharedPreferences\00", align 1
@.tmr.28 = private unnamed_addr constant [21 x i8] c"android/app/Activity\00", align 1
@.tmr.29 = private unnamed_addr constant [25 x i8] c"android/app/AlarmManager\00", align 1
@.tmr.30 = private unnamed_addr constant [24 x i8] c"android/app/Application\00", align 1
@.tmr.31 = private unnamed_addr constant [26 x i8] c"android/app/PendingIntent\00", align 1
@.tmr.32 = private unnamed_addr constant [30 x i8] c"java/nio/channels/FileChannel\00", align 1
@.tmr.33 = private unnamed_addr constant [51 x i8] c"java/nio/channels/spi/AbstractInterruptibleChannel\00", align 1
@.tmr.34 = private unnamed_addr constant [24 x i8] c"java/io/FileInputStream\00", align 1
@.tmr.35 = private unnamed_addr constant [20 x i8] c"java/io/InputStream\00", align 1
@.tmr.36 = private unnamed_addr constant [20 x i8] c"java/io/IOException\00", align 1
@.tmr.37 = private unnamed_addr constant [21 x i8] c"java/io/OutputStream\00", align 1
@.tmr.38 = private unnamed_addr constant [19 x i8] c"java/util/Calendar\00", align 1
@.tmr.39 = private unnamed_addr constant [19 x i8] c"java/util/Iterator\00", align 1
@.tmr.40 = private unnamed_addr constant [28 x i8] c"java/util/function/Consumer\00", align 1
@.tmr.41 = private unnamed_addr constant [18 x i8] c"java/lang/Boolean\00", align 1
@.tmr.42 = private unnamed_addr constant [15 x i8] c"java/lang/Byte\00", align 1
@.tmr.43 = private unnamed_addr constant [20 x i8] c"java/lang/Character\00", align 1
@.tmr.44 = private unnamed_addr constant [16 x i8] c"java/lang/Class\00", align 1
@.tmr.45 = private unnamed_addr constant [33 x i8] c"java/lang/ClassNotFoundException\00", align 1
@.tmr.46 = private unnamed_addr constant [17 x i8] c"java/lang/Double\00", align 1
@.tmr.47 = private unnamed_addr constant [20 x i8] c"java/lang/Exception\00", align 1
@.tmr.48 = private unnamed_addr constant [16 x i8] c"java/lang/Float\00", align 1
@.tmr.49 = private unnamed_addr constant [23 x i8] c"java/lang/CharSequence\00", align 1
@.tmr.50 = private unnamed_addr constant [18 x i8] c"java/lang/Integer\00", align 1
@.tmr.51 = private unnamed_addr constant [15 x i8] c"java/lang/Long\00", align 1
@.tmr.52 = private unnamed_addr constant [17 x i8] c"java/lang/Object\00", align 1
@.tmr.53 = private unnamed_addr constant [27 x i8] c"java/lang/RuntimeException\00", align 1
@.tmr.54 = private unnamed_addr constant [16 x i8] c"java/lang/Short\00", align 1
@.tmr.55 = private unnamed_addr constant [17 x i8] c"java/lang/String\00", align 1
@.tmr.56 = private unnamed_addr constant [17 x i8] c"java/lang/Thread\00", align 1
@.tmr.57 = private unnamed_addr constant [35 x i8] c"mono/java/lang/RunnableImplementor\00", align 1
@.tmr.58 = private unnamed_addr constant [20 x i8] c"java/lang/Throwable\00", align 1
@.tmr.59 = private unnamed_addr constant [29 x i8] c"java/lang/ClassCastException\00", align 1
@.tmr.60 = private unnamed_addr constant [16 x i8] c"java/lang/Error\00", align 1
@.tmr.61 = private unnamed_addr constant [35 x i8] c"java/lang/IllegalArgumentException\00", align 1
@.tmr.62 = private unnamed_addr constant [32 x i8] c"java/lang/IllegalStateException\00", align 1
@.tmr.63 = private unnamed_addr constant [36 x i8] c"java/lang/IndexOutOfBoundsException\00", align 1
@.tmr.64 = private unnamed_addr constant [19 x i8] c"java/lang/Runnable\00", align 1
@.tmr.65 = private unnamed_addr constant [23 x i8] c"java/lang/LinkageError\00", align 1
@.tmr.66 = private unnamed_addr constant [31 x i8] c"java/lang/NoClassDefFoundError\00", align 1
@.tmr.67 = private unnamed_addr constant [31 x i8] c"java/lang/NullPointerException\00", align 1
@.tmr.68 = private unnamed_addr constant [17 x i8] c"java/lang/Number\00", align 1
@.tmr.69 = private unnamed_addr constant [39 x i8] c"java/lang/ReflectiveOperationException\00", align 1
@.tmr.70 = private unnamed_addr constant [28 x i8] c"java/lang/StackTraceElement\00", align 1
@.tmr.71 = private unnamed_addr constant [40 x i8] c"java/lang/UnsupportedOperationException\00", align 1
@.tmr.72 = private unnamed_addr constant [25 x i8] c"mono/android/TypeManager\00", align 1
@.tmr.73 = private unnamed_addr constant [35 x i8] c"crc64752b970231ac5f1e/MainActivity\00", align 1
@.tmr.74 = private unnamed_addr constant [51 x i8] c"crc64752b970231ac5f1e/WaterCountdownWidgetProvider\00", align 1
@.tmr.75 = private unnamed_addr constant [20 x i8] c"[Ljava/lang/Object;\00", align 1
...
@.tmr.84 = private unnamed_addr constant [37 x i8] c"net/dot/jni/internal/JavaProxyObject\00", align 1
@.tmr.85 = private unnamed_addr constant [40 x i8] c"net/dot/jni/internal/JavaProxyThrowable\00", align 1
@.tmr.86 = private unnamed_addr constant [24 x i8] c"net/dot/jni/ManagedPeer\00", align 1

;TypeMapModule
@.TypeMapModule.0_assembly_name = private unnamed_addr constant [21 x i8] c"WaterCountdownWidget\00", align 1
